    ...
    _root_node(nullptr)
{
    ...
    ret->registerModel<MoveCloseToObjectNodeModel>("Action");
    ret->registerModel<GraspObjectNodeModel>("Action");
    ret->registerModel<PutObjectInFrontNodeModel>("Action");
    ret->registerModel<PutObjectOnSideModel>("Action");
