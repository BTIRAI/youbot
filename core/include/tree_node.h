...
enum NodeType {ACTION_NODE, CONDITION_NODE, CONTROL_NODE, YARP_ACTION_NODE};
    enum DrawNodeType {PARALLEL, SELECTOR, SEQUENCE, SEQUENCESTAR, SELECTORSTAR, ACTION, CONDITION,DECORATOR, ROOT, SUBTREE, MOVETO, GRASP, PUTFRONT, PUTSIDE, ISROBOTCLOSE, ISOBJECTONOBJECT, ISOBJECTGRASPED};
